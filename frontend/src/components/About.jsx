...
export default function About({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-black/10 backdrop-blur-md flex items-center justify-center px-4">
      <div className="relative">
        {/* Glowing aura */}
        <div className="absolute inset-0 rounded-2xl bg-black/20 blur-xl  z-0" />

        {/* Modal content */}
        <div
          ref={modalRef}
          className="relative z-10 bg-white/5 backdrop-blur-2xl border border-zinc-700 rounded-2xl shadow-[0_0_40px_rgba(255,255,255,0.1)] p-6 w-full max-w-xs sm:max-w-sm md:max-w-md lg:w-[40vw] xl:max-w-2xl max-h-[90vh] overflow-y-auto"
        >
          {/* Close button */}
          <button
            onClick={handleClose}
          ...
          {/* Title */}
          <h2 className="text-3xl font-bold text-center mb-6 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent font-amiamie">
            Synthra
          </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-xl bg-white/5 border border-zinc-700 hover:border-red-500 transition">
              <h3 className="text-lg font-amiamie font-semibold text-blue-400 mb-2">
                ⚡ Functionality
              </h3>
            ...
            {/* Model */}
            <div className="p-4 rounded-xl bg-white/5 border border-zinc-700 hover:border-red-500 transition">
              <h3 className="text-lg font-amiamie font-semibold text-purple-400 mb-2">
                🧠 Model
              </h3>
              <p className="text-zinc-300 font-light font-amiamie-round leading-tight">
            ...
            {/* Tools */}
            <div className="p-4 rounded-xl bg-white/5 border border-zinc-700 hover:border-red-500 transition">
              <h3 className="text-lg font-amiamie font-semibold text-green-400 mb-2">
                🛠 Tools
              </h3>
              <p className="text-zinc-300 font-light font-amiamie-round leading-tight">
